module.exports = function (config) {
  ...
  var libBase = 'out-tsc/tests-output/';       // transpiled app JS and map files
  ...
  config.set({
    ...
    files: [
      ...
      // required for all components that use http client
      // tslib
    ...
    proxies: {
      ...
      '/base/out-tsc/tests-output/node_modules/': '/base/node_modules/'
    },
